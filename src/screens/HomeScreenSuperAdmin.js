...
const HomeScreenSuperAdmin = ({navigation,route}) => {
 ...
 // const {navigation}=props;
  ...
  const exampleGIF = Image.resolveAssetSource(exampleImage2).uri;
    ...
    const [items, setItems] = React.useState([
      { id:1,name: 'ADMINS', code: '#3498db' },
      { id:2,name: 'USERS', code: '#f39c12' },
      { id:3,name: 'ADD ADMIN', code: '#e74c3c' },
      { id:4,name: 'ADD USER', code: '#16a085' },
      { id:5,name: 'MESSAGES', code: '#e74c3c' },
...
const addAdmin=()=>{
  //alert('add admin list');
  navigation.navigate('AddProfile',{usertype:'Admin'});
}
