...
<Text style={{marginTop: 1, fontSize: 18, fontWeight: 'bold'}}>
  ...
  />:null}
        ...
        <View style={styles.action}>
          <FontAwesome name="bookmark" color={colors.text} size={20} />
          <TextInput
            placeholder="Total VAT : 2.5"
            placeholderTextColor="#666666"
            autoCorrect={false}
            style={[
              styles.textInput,
        ...
        <View style={styles.action}>
          <Feather name="dollar-sign" color={colors.text} size={20} />
          
          <TextInput
            placeholder="Total Amount : 4200"
            placeholderTextColor="#666666"
